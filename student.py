...
# ===============================
df = pd.read_csv('Student_Performance.csv')  # Make sure this CSV is in the same folder
lb = LabelEncoder()
...
st.write("Fill in the student details to predict the **Performance Index** and check placement eligibility.")
